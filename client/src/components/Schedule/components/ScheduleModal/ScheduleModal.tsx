...
const ScheduleModal = ({isOpen, closeModal}: { isOpen: boolean, closeModal: () => void }) => {
    ...
    const openRecordDetails = () => setIsOpenRecordDetails(true);
    const closeRecordDetails = () => setIsOpenRecordDetails(false);
        ...
        >
            <div className={styles.modalContent}>
                ...
                <Card className={styles.modalCardContent}>
                    {
                        !isOpenRecordDetails && (
                            <Typography onClick={() => openRecordDetails()} className={styles.modalText}>
                                Раскрыть данные записи <DownOutlined />
                            </Typography>
                        )
                    }
                    {
                        isOpenRecordDetails && (
                            <Typography onClick={() => closeRecordDetails()} className={styles.modalText}>
                                Скрыть данные записи <DownOutlined />
                            </Typography>
                        )
                    }
                    {
